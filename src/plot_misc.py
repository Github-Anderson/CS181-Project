...
# 新数据：
data00 = {
    "G":   ["39/12/49", "69/0/31", "79/1/20"],
    "M":   ["53/0/47",  "0/0/100", "0/0/100"],
    "MLS": ["54/0/46",  "0/0/100", "0/0/100"],
}

data01 = {
    "G":   ["45/5/50", "77/0/23", "74/1/25"],
    "M":   ["50/0/50", "0/0/100", "0/0/100"],
    "MLS": ["46/0/54", "0/0/100", "0/0/100"],
}

data10 = {
    "G":   ["18/51/31", "63/0/37", "71/0/29"],
    "M":   ["89/5/6",   "0/0/100", "0/0/100"],
    "MLS": ["87/6/7",   "0/0/100", "0/0/100"],
}

data11 = {
    "G":   ["13/69/18", "64/6/37",  "58/11/31"],
    "M":   ["57/22/21", "0/0/100", "0/0/100"],
    "MLS": ["58/26/16", "0/0/100", "0/0/100"],
}

data21 = {
    "G":   ["0/100/0",   "17/83/0",  "17/83/0"],
    "M":   ["12/74/14",  "0/0/100",  "0/0/100"],
    "MLS": ["13/77/10",  "0/0/100",  "0/0/100"],
}

data22 = { # This data is already numeric
    "G":   [1.5018, 3.5511, 2.3924],
    "M":   [2.8983, float('inf'), float('inf')],
    "MLS": [2.3230, float('inf'), float('inf')],
}
